...
export const LoopExpression = (body: t.BlockExpression, condition: t.Expression = { type: 'BooleanLiteral', value: true }): t.LoopExpression => ({ type: 'LoopExpression', body, condition })
export const LoopOverExpression = (iterable: t.Expression, body: t.BlockExpression, alias: t.Identifier = { type: 'Identifier', name: 'it' }): t.LoopOverExpression => ({ type: 'LoopOverExpression', body, alias, iterable })
