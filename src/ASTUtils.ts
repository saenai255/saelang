...
export const NativeCodeExpression = (value: string): t.NativeCodeExpression => ({ type: 'NativeCodeExpression', value })
export const StructDeclarationStatement = (typeStruct: t.TypeStruct): t.StructDeclarationStatement => ({ type: 'StructDeclarationStatement', body: typeStruct })
export const TypeStruct = (args: t.TypedArgument[]): t.TypeStruct => NamedTypeStruct(undefined, args)
export const NamedTypeStruct = (name: string, args: t.TypedArgument[]): t.TypeStruct => ({ type: 'TypeStruct', name, fields: args })
export const StructConstructorExpression = (typeStruct: t.TypeStruct, args: t.StructConstructorNamedFieldAssignment[]): t.StructConstructorExpression => ({ type: 'StructConstructorExpression', struct: typeStruct, params: args })
